...
class Edit extends \ASG\PropertySystem\Controller\Adminhtml\Property
{
    ...
    public function execute()
    {
        ...
        $this->initPage($resultPage)->addBreadcrumb(
            $id ? __('Edit Property') : __('New Property'),
            $id ? __('Edit Property') : __('New Property')
        );
        $resultPage->getConfig()->getTitle()->prepend(__('Property'));
        $resultPage->getConfig()->getTitle()->prepend($model->getId() ? __('Edit Property %1', $model->getId()) : __('New Property'));
        return $resultPage;
    }
}
